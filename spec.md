...
- **Image Gen**: Stable Diffusion XL (Hugging Face)
...
- **Process**:
    ...
    3.  **Generate**: Send prompt to Hugging Face Inference API.
    4.  **Save**: `assets/architecture_diagram.png`.
- **Style**: Hyper-realistic 3D isometric, dark mode sci-fi, volumetric lighting, glass encasements, neon energy transition (cyan to purple).
...
2.  Set environment variables:
    ...
    - Set `HF_TOKEN` (Get from [Hugging Face](https://huggingface.co/settings/tokens)).
